...
async def reply(client, message): 
    try:
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b> Silahkan join grup VVIP dulu! Untuk harga murah banget! Informasi lebih lanjut PC 👉🏿 [Admin Winnie](https://t.me/pctititestetiq) atau [Admin GYN](https://t.me/Slapurtongue) .</b>", disable_web_page_preview=True)
